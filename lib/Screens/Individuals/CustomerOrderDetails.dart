        ...
        child: Container(
            child: ListView(
              children: [
                ...
                Env.customTile('مدل دیزاین لباس:',widget.data.designType??'',()=>_updateData(context, widget.data.designType, 2), context),
                Env.customTile('تعداد فرمایش:',widget.data.quantity+' جوره '??'',()=>_updateData(context, widget.data.quantity, 3), context),
                Env.customTile('وضعیت:',widget.data.orderState??'',()=>_updateData(context, widget.data.orderDate, 6), context),
                Env.customTile('دیزاین یخن:',widget.data.collarDesign??'',()=>_updateData(context, widget.data.collarDesign, 6), context),
                Env.customTile('دیزاین آستین:',widget.data.sleeveDesign??'',()=>_updateData(context, widget.data.sleeveDesign, 6), context),
                Env.customTile('متراژ رخت:',widget.data.textTileMeter+ ' متر'??'',()=>_updateData(context, widget.data.textTileMeter, 4), context),
                ...
                Env.customTile('تاریخ تسلیمی:',widget.data.deliveryDate.toString()??'',()=>_updateData(context, widget.data.deliveryDate, 8), context),
