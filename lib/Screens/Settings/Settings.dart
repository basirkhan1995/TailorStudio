     ...
     // appBar: Env.appBar(context, 'Setting'),
      body: ListView(
        children: [
          ...
          Env.settingTile('Notifications', 'To send message for delivery', Icons.notifications_active, NotificationCenter(), context),
          Env.settingTile('Help', 'Contact us', Icons.help_rounded, HelpCenter(), context),
        ],
      )
    );
  }
